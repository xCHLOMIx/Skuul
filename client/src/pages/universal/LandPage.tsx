    ...
    return (
        <div className='flex flex-col w-full items-center gap-10 absolute bottom-0'>
            <div className='flex flex-col gap-8 items-center'>
                ...
                <p className='w-[500px] text-center text-black/70 text-lg'>All-in-one Library Management System to track books, handle reminders, and streamline borrowing fast, simple, and reliable.</p>
                <div className='flex gap-2'>
                    <Link to='/student/dashboard'>
                    <button className='bg-primary p-3 text-white px-4 cursor-pointer'>Get started</button>
                    </Link>
                    <Link to='/admin/dashboard'>
                    <button className='bg-white p-3 text-primary px-4 cursor-pointer'>Admin panel</button>
                    </Link>
                </div>
            </div>
