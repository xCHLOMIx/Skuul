  ...
  return (
    <div>
      <div>
        ...
        <span className='text-sm max-md:text-xs max-sm:text-[10] text-alt3'>Welcome back, <span className='font-bold capitalize'>{admin.toLowerCase()}</span></span>
      </div>
      <div className='mt-5'>
        ...
        <div className='mt-3 grid grid-cols-3 max-xl:grid-cols-2 gap-4 max-md:gap-3 max-sm:gap-2'>
          ...
          <div className='bg-white border border-alt4 p-4 max-md:p-3 max-sm:p-2 flex justify-between'>
            <div className='flex flex-col justify-between'>
              <h3 className='font-bold text-xl max-xl:text-base max-md:text-sm text-primary'>Students</h3>
